...
class LitEEGPTCausal(pl.LightningModule):
    ...
    def test_step(self, batch, batch_idx):
        fmri, eeg_index_linear_raw, eeg_index_linear_smoothed, eeg_index_binary, vigilance_seg = batch
        fmri_all_feats, fmri_logits = self.forward(fmri, fmri, is_train=False) 
...
if __name__=="__main__":
    ...
    eegfmri_vu_pat_gt_zeroshot_dataset = build_dataset_zeroshot("eegfmri_vu_pat_alphatheta_smallinterval_1024_gt")
    eegfmri_vu_pat_gt_zeroshot_loader  = DataLoader(eegfmri_vu_pat_gt_zeroshot_dataset,  batch_size=batch_size, shuffle=False, num_workers=8)
    print("zeroshot of pat populations")
    trainer.test(model, dataloaders=eegfmri_vu_pat_gt_zeroshot_loader)
    
    save_feats(model, eegfmri_vu_pat_gt_zeroshot_loader, "eegfmri_vu_pat_gt_alphatheta_smallinterval_1024")
    save_feats(model, eegfmri_vu_pat_gt_zeroshot_loader, "eegfmri_vu_pat_gt_alphatheta_smallinterval_1024")
